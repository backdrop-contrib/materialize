...
$form['materialize_backgrounds']['materialize_body_main_background'] = array(
      '#type' => 'textarea',
...
$form['materialize_backgrounds']['materialize_body_main_background_retina'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for high resolution screens for the main page area in a layout.'),
      '#default_value' => theme_get_setting('materialize_body_main_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_body_main_background_blurred'] = array(
      '#type' => 'checkbox',
...
//l-calltoaction area
$form['materialize_backgrounds']['materialize_footer_main_background'] = array(
      '#type' => 'textarea',
...
$form['materialize_backgrounds']['materialize_footer_main_background_retina'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('materialize_footer_main_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_footer_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
...
//juiced-main area
$form['materialize_backgrounds']['materialize_juiced_main_background'] = array(
      '#type' => 'textarea',
...
$form['materialize_backgrounds']['materialize_juiced_main_background_retina'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('materialize_juiced_main_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_juiced_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
...
//statement 1
$form['materialize_backgrounds']['materialize_statement1_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the big statement 1 area in a layout.'),
      '#default_value' => theme_get_setting('materialize_statement1_background', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement1_background_retina'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('materialize_statement1_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement1_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('materialize_statement1_background_blurred', 'materialize'),
    );
...
//statement 2
$form['materialize_backgrounds']['materialize_statement2_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the big statement 2 area in a layout.'),
      '#default_value' => theme_get_setting('materialize_statement2_background', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement2_background_retina'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('materialize_statement2_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement2_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('materialize_statement2_background_blurred', 'materialize'),
    );
...
//statement 3
$form['materialize_backgrounds']['materialize_statement3_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the big statement 3 area in a layout.'),
      '#default_value' => theme_get_setting('materialize_statement3_background', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement3_background_retina'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('materialize_statement3_background_retina', 'materialize'),
    );

$form['materialize_backgrounds']['materialize_statement3_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('materialize_statement3_background_blurred', 'materialize'),
    );
