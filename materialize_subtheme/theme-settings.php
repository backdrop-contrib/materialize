...
$form['materialize_backgrounds']['body_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['body_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['body_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('body_main_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['footer_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['footer_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['footer_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('footer_main_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['juiced_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['juiced_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['juiced_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('juiced_main_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement1_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement1_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['statement1_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement1_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement2_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement2_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['statement2_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement2_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement3_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background', 'materialize_subtheme'),
    );
...
$form['materialize_backgrounds']['statement3_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background_retina', 'materialize_subtheme'),
    );

$form['materialize_backgrounds']['statement3_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement3_background_blurred', 'materialize_subtheme'),
    );
...
$form['materialize_cdn_css'] = array(
    ...
    '#default_value' => theme_get_setting('materialize_cdn_css', 'materialize_subtheme'),
  );
...
$form['materialize_cdn_js'] = array(
    ...
    '#default_value' => theme_get_setting('materialize_cdn_js', 'materialize_subtheme'),
  );
...
$form['materialize_dropdown'] = array(
    ...
    '#default_value' => theme_get_setting('materialize_dropdown', 'materialize_subtheme'),
  );
...
$form['materialize_script1'] = array(
      ...
      '#default_value' => theme_get_setting('materialize_script1', 'materialize_subtheme'),
    );

$form['materialize_script2'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script buttons.js'),
      '#default_value' => theme_get_setting('materialize_script2', 'materialize_subtheme'),
    );

$form['materialize_script3'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script cards.js'),
      '#default_value' => theme_get_setting('materialize_script3', 'materialize_subtheme'),
    );

$form['materialize_script4'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script character_counter.js'),
      '#default_value' => theme_get_setting('materialize_script4', 'materialize_subtheme'),
    );

$form['materialize_script5'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script collapsible.js'),
      '#default_value' => theme_get_setting('materialize_script5', 'materialize_subtheme'),
    );

$form['materialize_script6'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script picker.date.js'),
      '#default_value' => theme_get_setting('materialize_script6', 'materialize_subtheme'),
    );

$form['materialize_script7'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script picker.js'),
      '#default_value' => theme_get_setting('materialize_script7', 'materialize_subtheme'),
    );

$form['materialize_script8'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script dropdown.js'),
      '#default_value' => theme_get_setting('materialize_script8', 'materialize_subtheme'),
    );

$form['materialize_script9'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script forms.js'),
      '#default_value' => theme_get_setting('materialize_script9', 'materialize_subtheme'),
    );

$form['materialize_script10'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script hammer.js for touch interactions'),
      '#default_value' => theme_get_setting('materialize_script10', 'materialize_subtheme'),
    );

$form['materialize_script11'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script jquery.hammer.js for JQuery based touch interactions'),
      '#default_value' => theme_get_setting('materialize_script11', 'materialize_subtheme'),
    );

$form['materialize_script12'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script jquery.easing.js for JQuery based animations'),
      '#default_value' => theme_get_setting('materialize_script12', 'materialize_subtheme'),
    );

$form['materialize_script13'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script jquery.timeago.js'),
      '#default_value' => theme_get_setting('materialize_script13', 'materialize_subtheme'),
    );

$form['materialize_script14'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script leanModal.js'),
      '#default_value' => theme_get_setting('materialize_script14', 'materialize_subtheme'),
    );

$form['materialize_script15'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script materialbox.js'),
      '#default_value' => theme_get_setting('materialize_script15', 'materialize_subtheme'),
    );

$form['materialize_script16'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script parallax.js'),
      '#default_value' => theme_get_setting('materialize_script16', 'materialize_subtheme'),
    );

$form['materialize_script17'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script prism.js'),
      '#default_value' => theme_get_setting('materialize_script17', 'materialize_subtheme'),
    );

$form['materialize_script18'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script pushpin.js'),
      '#default_value' => theme_get_setting('materialize_script18', 'materialize_subtheme'),
    );

$form['materialize_script19'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script scrollFire.js'),
      '#default_value' => theme_get_setting('materialize_script19', 'materialize_subtheme'),
    );

$form['materialize_script20'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script scrollspy.js'),
      '#default_value' => theme_get_setting('materialize_script20', 'materialize_subtheme'),
    );

$form['materialize_script21'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script sideNav.js'),
      '#default_value' => theme_get_setting('materialize_script21', 'materialize_subtheme'),
    );

$form['materialize_script22'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script slider.js'),
      '#default_value' => theme_get_setting('materialize_script22', 'materialize_subtheme'),
    );

$form['materialize_script23'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script tabs.js'),
      '#default_value' => theme_get_setting('materialize_script23', 'materialize_subtheme'),
    );

$form['materialize_script24'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script toasts.js'),
      '#default_value' => theme_get_setting('materialize_script24', 'materialize_subtheme'),
    );

$form['materialize_script25'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script tooltip.js'),
      '#default_value' => theme_get_setting('materialize_script25', 'materialize_subtheme'),
    );

$form['materialize_script26'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script transitions.js'),
      '#default_value' => theme_get_setting('materialize_script26', 'materialize_subtheme'),
    );

$form['materialize_script27'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script velocity.js'),
      '#default_value' => theme_get_setting('materialize_script27', 'materialize_subtheme'),
    );

$form['materialize_script28'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script waves.js for button effects'),
      '#default_value' => theme_get_setting('materialize_script28', 'materialize_subtheme'),
    );

$form['materialize_script29'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script materialize_custom.js for an example of some sample webpage effects'),
      '#default_value' => theme_get_setting('materialize_script29', 'materialize_subtheme'),
    );

$form['materialize_script30'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script modernizr.js'),
      '#default_value' => theme_get_setting('materialize_script30', 'materialize_subtheme'),
    );

$form['materialize_script31'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script jquery-validate.js'),
      '#default_value' => theme_get_setting('materialize_script31', 'materialize_subtheme'),
    );

$form['materialize_script32'] = array(
      '#type' => 'checkbox',
      '#title' => t('Load script fastclick.js'),
      '#default_value' => theme_get_setting('materialize_script32', 'materialize_subtheme'),
    );
...
$form['sass'] = array(
    ...
    '#default_value' => theme_get_setting('sass', 'materialize_subtheme'),
  );
